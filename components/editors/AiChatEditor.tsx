    ...
    return (
        <div className="bg-[var(--panel-bg)] border border-[var(--border-color)] h-full flex flex-col text-[var(--text-color)] rounded-xl">
            <div className="p-5 border-b border-[var(--border-color)] flex items-center justify-between">
                <div className="flex items-center">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-[var(--accent-color)]">{t.chester_subtitle_editor}</p>
                    </div>
                </div>
                {messages.length > 0 && (
            ...
            <div className="flex-1 p-6 overflow-y-auto space-y-4">
                {messages.length === 0 && (
                    <div className="text-center text-[var(--text-color-light)]">{t.chester_prompt_placeholder}</div>
                )}
                {messages.map((msg) => (
